...
Consulting responses are generally more data-driven and focus on tying back to the higher-level business strategy. You're making a big recommendation to a client, and they're the ones responsible for execution. (e.g. mergers and acquistions, making a decision on what to invest in) 

PM responses should also be data-driven, when appropriate, but your answer will focus more on a specific product/feature set and you'll emphasize how your recommendation affects the product team (who have to actually implement any given plan) and the users.
...
PM interviews almost always involve a major take-home component. I can't remember one that didn't. Typically, you're asked to write a Product Requirements Document (PRD) for a specific case modeled after a problem the company has encountered. Sometimes you're even expected to present it at your next interview with accompanying visuals, if appropriate.  
