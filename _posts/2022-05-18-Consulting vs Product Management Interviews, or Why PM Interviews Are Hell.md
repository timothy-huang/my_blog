...
Okay, now that that's out of the way, I'll begin with a few qualifiers. I'm speaking from my own experience. I've only recruited for entry-level roles for both consulting and product management. In consulting, I interviewed at PwC and Accenture for tech consulting and strategy consulting internships, respectively. For PM, I've interviewed at over a dozen companies, from startups like Duolingo to tech giants like Intuit for both internships and full-time roles.
...
One technique is to use an analogy like "PMs are like the conductor of an orchestra" (although a bit cliche), in order to illustrate how you're influencing and driving alignment across multiple functions.

I don't remember a "What is a consultant?" question ever coming up in interviews. Probably because it's not as important for consulting analysts to know the specifics of what their work will look like, so much as their ability to learn quickly on the job. 
...
Consulting responses are generally more data-driven and focus on tying back to the higher-level business strategy. You're making a big recommendation to a client, and they're the ones responsible for execution. Think mergers and acquistions or making a decision on what business unit to invest in. It also helps if you have a few common statistics like the population of the US memorized in the back of your head.

PM responses should also be data-driven, when possible, but your answer will focus more on a specific product/feature set and you'll emphasize how your recommendation affects the product team (who have to actually implement the strategy) and the users.

# PM interviews require you to make more assumptions

In consulting interviews, you're expected to ask the interviewer questions in order to clarify the question and uncover new data. There's often a "correct" answer which you can arrive at, and some cases just require you to make a simple calculation like conducting a break-even analysis. This models what an actual consulting engagement looks like. A client has a problem, and you have to (1) probe them to get to the root of the problem and (2) do a bunch of external research to make an informed recommendation. 
...
Entry-level strategy consulting interviews are pretty unlikely to have anything technical. 
...
- [Pre-interview research](https://productmanagerhq.com/product-manager-interview-pre-interview-research/) article by Clement Kao (Product Management HQ) for a structured and prioritized way to prep before interviewing with a new company 
