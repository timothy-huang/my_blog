...
- **Nice (free) themes.** Jekyll has a ton of open-sourced themes that people have built over time that don't force you to display a watermark at the bottom. With a basic knowledge of html/css, you can customize the themes to your liking. Minima is the default (what I'm using as of writing this post), and it's clean and responsive. 
